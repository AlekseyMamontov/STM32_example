...
/*
 * Phase,Target Bitrate,NTQ,NBRP/DBRP,NTSEG1 (BS1),NTSEG2 (BS2),NSJW/DSJW,Register Value (hex),Actual Bitrate,Notes (SP %)
Nominal,125 кбіт/с,16,39,13,2,3,NBTP=0x1F700D02,125 кбіт/с,"87.5% (short bus, legacy)"
Nominal,250 кбіт/с,16,19,13,2,3,NBTP=0x0F300D02,250 кбіт/с,87.5% (standard automotive)
Nominal,500 кбіт/с,16,9,13,2,3, NBTP=0x05A00D02,500 кбіт/с,87.5% (твій базовий)
Nominal,1 Мбіт/с,16,4,13,2,3,   NBTP=0x02D00D02,1 Мбіт/с,"87.5% (твій FDCAN2, exact)"
Data,2 Мбіт/с,20,1,14,5,4,   DBTP=0x07010E05,2 Мбіт/с,"75% (BRS=1, IoT)"
Data,5 Мбіт/с,16,0,11,3,3,   DBTP=0x03000B03,5 Мбіт/с,"75% (high-speed, short wires)"
Data,8 Мбіт/с,10,0,7,1,1,    DBTP=0x01000701,8 Мбіт/с,"80% (max, twisted pair <1m)"

 */

#endif /* INC_CANFD_STM32G473_H_ */
